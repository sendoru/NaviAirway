...
def main():
    ...
    generation_info_csv_path = save_path.rstrip(
        '/').rstrip('\\') + '/' + "generation_info.csv"
    ...
    trace_volume_by_gen_info_csv_path = save_path.rstrip(
        '/').rstrip('\\') + '/' + "trace_volume_by_gen_info.csv"
    if os.path.exists(trace_volume_by_gen_info_csv_path):
        trace_volume_by_gen_info = pd.read_csv(
            trace_volume_by_gen_info_csv_path)
    ...
    for cur_seg_path in seg_path:
        ...
        break_and_save(cur_seg_path, save_path, generation_info,
                       trace_volume_by_gen_info, trace_slice_area_info, args, pixdim_info)
        generation_info = pd.read_csv(generation_info_csv_path)
        trace_volume_by_gen_info = pd.read_csv(
            trace_volume_by_gen_info_csv_path)
